...
- сеттеры для сохранения информации о способе оплаты, общей сумме заказа, выбранных для оплаты товарах.
...
#### Класс Form
Предназначен для реализации элемента формы содержащей поля ввода. При сабмите инициирует событие передавая в него объект с данными из полей ввода формы. При изменении данных в полях ввода инициирует событие изменения данных. Предоставляет методы для отображения ошибок и управления активностью кнопки сохранения.\
Поля класса:
...
- `preview:chenge` - изменение открываемой в модальном окне карточки
- `basketProduct:chenge` - изменения в корзине продуктов
...
- `check:buttonState` - событие при нажатии на кнопку выбора оплаты
